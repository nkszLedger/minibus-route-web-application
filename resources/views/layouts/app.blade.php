  ...
  <header class="main-header">
	  <div class="inside-header clearfix">
		<nav class="main-nav" role="navigation">
			<h2 class="nav-brand"><a href="/"><img src="minibus/free-minibus-vector.png" class="max-w-50" alt="minibus-app"></a></h2>
			...
			<ul id="main-menu" class="sm sm-blue">
                ...
                <li><a href="#"><i class="ti-files mx-5"></i>MEMBER REGISTRATION</a>
                    <ul>
                ...
                <li><a href="#"><i class="ti-files mx-5"></i>MEMBER MANAGEMENT</a>
                    <ul>
                        <li><a href="pages/layout_boxed.html">View</a></li>
                    </ul>
                </li>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center justify-content-between">
				...
				<div class="w-p60">
					<!-- Search Form -->
					<form id="labnol" method="get" action="http://Voice-admin-template.multipurposethemes.com/main-ltr/">
						<div class="form-group mb-0 mr-5">
							<div class="input-group">
								...
								<div class="input-group-append">
									<button type="button" onclick="startDictation()" class="btn btn-rounded btn-white"><img src="../images/Google_mic.png" class="img-fluid w-15" alt=""></button>
								</div>
							</div>
						</div>
					</form>
		...
		<section class="content">
			<div class="row">
				...
				<div class="col-12 col-xl-4">
				  <div class="box">
					<div class="box-header with-border">
					  <h4 class="box-title">Site User</h4>
					</div>
					<div class="box-body">
...
{{--									<div id="monthly-data" class="h-350"></div>--}}
{{--								</div>--}}
{{--								<div class="col-lg-4 col-12">--}}
{{--									<ul class="list-unstyled">--}}
{{--                                        <li>--}}
{{--                                            <h3 class="mb-0">4,215</h3>--}}
{{--											<div class="d-flex justify-content-between">--}}
{{--												<small>Total orders in Day</small>--}}
{{--												<div>40% <i class="fa fa-level-up"></i></div>--}}
{{--											</div>--}}
{{--                                            <div class="progress">--}}
...
{{--                                        </li>--}}
{{--                                        <li>--}}
{{--                                            <h3 class="mb-0">2,458</h3>--}}
{{--											<div class="d-flex justify-content-between">--}}
{{--												<small>Orders in last month</small>--}}
{{--												<div>60% <i class="fa fa-level-down"></i></div>--}}
{{--											</div>--}}
{{--                                            <div class="progress">--}}
{{--												<div class="progress-bar progress-bar-striped progress-bar-danger" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 60%">--}}
{{--												</div>--}}
{{--										    </div>--}}
{{--                                        </li>--}}
{{--                                        <li>--}}
{{--                                            <h3 class="mb-0">8,458</h3>--}}
{{--											<div class="d-flex justify-content-between">--}}
{{--												<small>Monthly income from orders</small>--}}
{{--												<div>20% <i class="fa fa-bolt"></i></div>--}}
{{--											</div>--}}
{{--                                            <div class="progress">--}}
{{--												<div class="progress-bar progress-bar-striped progress-bar-info" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 20%">--}}
{{--												</div>--}}
{{--										    </div>--}}
{{--                                        </li>--}}
{{--                                        </ul>--}}
  ...
  <footer class="main-footer">
    <div class="pull-right d-none d-sm-inline-block">
        <ul class="nav nav-primary nav-dotted nav-dot-separated justify-content-center justify-content-md-end">
		  <li class="nav-item">
			<a class="nav-link" href="https://www.transport.gov.za/web/department-of-transport/contact-us">Contact Us</a>
		  </li>
		</ul>
    </div>
	  &copy; {{now()->year}} <a href="https://www.transport.gov.za">Department of Transport. </a> All Rights Reserved.
  </footer>
