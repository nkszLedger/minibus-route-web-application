                  ...
                  <div class="col-12">
                      ...
                      <div class="box box-default">
                          ...
                          <div class="box-body wizard-content">
                              <form action="test_create_member" id="member-form">
{{--                              {{ csrf_field() }}--}}
                                  <!-- Step 1 -->
                                  ...
                                  <section>
                                      ...
                                      <div class="row">
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  <label for="idnumber"> ID Number222 : <span class="danger">*</span> </label>
                                                  <input type="num" class="form-control required" id="idnumber" name="idnumber" maxlength="13"> </div>
                                          </div>
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  <label for="licensenumber"> License1 Number : <span class="danger">*</span> </label>
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  ...
                                                  <input type="tel" class="form-control required" id="wphoneNumber2" pattern="[0-9]" maxlength="10"> </div>
                                          </div>
                                      </div>
                                      <div class="row">
                                          <div class="col-md-6">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-6">
                                              ...
                                              <div class="form-group">
                                                  <button type="submit"  class="button btn-primary" href="" id="submit-member-form"> save to db</button>
                                              </div>
                                          </div>
