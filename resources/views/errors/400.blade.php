...
<head>
  <meta charset="utf-8">
    ...
    <title>Minibus Taxi Registration Admin - 400 Page not found </title>
...
<body class="hold-transition theme-fruit bg-img" style="background-image: url(minibus/images/auth-bg/bg-3.jpg);">
				...
				<div class="row justify-content-center no-gutters">
					<div class="col-xl-6 col-lg-7 col-md-6 col-12">
						<div class="rounded10 b-2 b-dashed border-info text-center">
						  	<h1 class="text-white font-size-180 font-weight-bold"> 400</h1>
						  	<h1 class="text-white">Uh-Ah</h1>
						  	<h3 class="text-white">You Seem To Be Trying To Find His Way Home</h3>
