...
<head>
  <meta charset="utf-8">
	...
	<title>Minibus Taxi Registration Admin - 500 Error </title>
				...
				<div class="row justify-content-center no-gutters">
					<div class="col-xl-6 col-lg-7 col-md-6 col-12">
						<div class="rounded10 b-2 b-dashed border-info text-center">
						  	<h1 class="text-white font-size-180 font-weight-bold"> 500</h1>
							...
							<h5 class="text-white mb-15">-- OR --</h5>
					  		<h4 class="text-white mb-25">Please try after some time</h4>	
					    </div>
					</div>
				</div>
			</div>
