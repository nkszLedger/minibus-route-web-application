...
class MilitaryVeteranPostRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            // 'gender_id' => 'required',
            // 'mvregion_id' => 'required',
            'emergency_contact_name' => 'sometimes|regex:/^[\pL\s\-]+$/u',
            'emergency_contact_relationship' => 'sometimes|required|regex:/^[\pL\s\-]+$/u',
            'emergency_contact_number' => 'sometimes|required|max:10',
            'region_leader_name' => 'sometimes|required|regex:/^[\pL\s\-]+$/u',
            'region_leader_contact_number' => 'sometimes|required|max:10',
